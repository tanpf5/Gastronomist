...
int rest_id = (Integer) request.getAttribute("rest_id");
      ...
      out.write("\t<link href=\"css/editMenu.css\" type=\"text/css\" rel=\"stylesheet\">\n");
      out.write("\n");
      out.write("  </head>\n");
      out.write("  \n");
      out.write("  <body>\n");
      ...
      out.write("<tr bgcolor=pink><th>name</th><th>price</th><th>times</th><th>mark</th><th>edit</th>\n");
 ...
 Iterator<Dish> iterator = dishes.iterator();
      ...
      out.print(mark);
      out.write("</td>\n");
      out.write("\t\t\t<td><input type=button value=edit \n");
      out.write("\t\t\tonclick=\"javascript:window.location.href='editDish.jsp?dish_id=");
      out.print(dish_id);
      out.write("&rest_id=");
      out.print(rest_id);
      out.write("'\"/></td>\n");
      out.write("\t\t\t<td><input type=button value=delete \n");
      out.write("\t\t\tonclick=\"javascript:window.location.href='deleteDish.do?dish_id=");
      out.print(dish_id);
      out.write("&rest_id=");
      out.print(rest_id);
      out.write("'\"/></td>\n");
      ...
      out.write("\n");
      out.write("</table>\n");
      out.write("<div class=\"register-button\"><a href=\"addDish.jsp?rest_id=");
      out.print(rest_id);
