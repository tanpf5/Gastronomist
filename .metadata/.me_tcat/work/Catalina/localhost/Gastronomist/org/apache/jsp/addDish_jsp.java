...
int rest_id = Integer.parseInt(request.getParameter("rest_id"));
      ...
      out.write("\t<link href=\"css/addDish.css\" type=\"text/css\" rel=\"stylesheet\">\n");
      out.write("\n");
      out.write("  </head>\n");
      out.write("  \n");
      out.write("  <body>\n");
      out.write("<div class=\"top-blank\"><img src=\"images/add.png\"></img></div>\n");
      out.write("<div class=\"background-register\">\n");
      out.write("<form action=\"addDish.do?rest_id=");
      out.print(rest_id );
